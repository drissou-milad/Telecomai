          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-slate-800 pb-3">
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="text-[10px] px-2 py-0.5 rounded bg-slate-800 text-amber-400 font-mono-num border border-slate-700">
                  Synthetic Demo
                </span>
              </div>
              <p className="text-xs text-slate-400 mt-0.5">
                Hourly throughput in Gbps: static illustrative values, not generated by a trained forecasting model.
              </p>
            </div>
            <div className="flex items-center gap-4 text-xs font-mono-num">
              <span className="flex items-center gap-1.5 text-sky-400">
                <span className="w-3 h-1.5 rounded-full bg-sky-400" /> Today (illustrative)
              </span>
              <span className="flex items-center gap-1.5 text-amber-400">
                <span className="w-3 h-1.5 rounded-full bg-amber-400 border border-dashed border-amber-300" /> Tomorrow (illustrative)
              </span>
            </div>
          </div>
